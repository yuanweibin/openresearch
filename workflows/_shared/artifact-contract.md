...
- `experiment.md`: inherited design revision, only the frozen items the real case relies on, one main variable, explicit Cycle-local deviations, minimum useful controls, the real-case method, Evidence criteria, stopping and resource boundaries, and material provenance or literature links.
